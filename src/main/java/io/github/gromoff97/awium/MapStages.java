...
final class MapStages {

    abstract static class MapTerminals<K, V, M extends Map<K, V>>
            extends ObjectStages.ObjectTerminals<M> {
    ...
    abstract static class MapConfigStages<K, V, M extends Map<K, V>>
        ...
        public final MapAwait.Until<K, V, M> stableFor(Duration stability) {
    ...
    static final class MapTerminalStage<K, V, M extends Map<K, V>>
            extends MapTerminals<K, V, M> implements MapAwait.Until<K, V, M> {
