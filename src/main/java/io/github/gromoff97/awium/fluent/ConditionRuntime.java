...
final class ConditionRuntime {
    ...
    static <Observed> PreservingCondition<Observed> preserving(String description,
            Function<Observed, ConditionEvaluation<Observed>> evaluator) {
    ...
    static <Observed, Result> Function<Observed, ConditionEvaluation<Result>> selectedEvaluator(AwaitCondition condition) {
        return (Function<Observed, ConditionEvaluation<Result>>) (Function<?, ?>) ConditionRuntime.<Observed, Result>runtime(condition).newEvaluator();
    }

    static <Observed, Result> Function<? super Observed, ? extends ConditionEvaluation<? extends Result>> evaluator(ConditionStage<? super Observed,
            ? extends Result> condition) {
        return ConditionRuntime.<Observed, Result>runtime(condition).newEvaluator();
    }

    static <Observed> Function<Observed, ConditionEvaluation<Observed>> preservingEvaluator(PreservingStage<? super Observed> condition) {
    ...
    static <Observed> Function<Observed, ConditionEvaluation<Observed>> expectedEvaluator(ExpectedStage<?> condition) {
    ...
    @SuppressWarnings("unchecked")
    static <Observed> Function<Observed, ConditionEvaluation<List<Observed>>> expectedSequenceEvaluator(ExpectedSequenceStage<?> condition) {
    ...
    static <Observed, Result> Function<Observed, ConditionEvaluation<Result>> narrowingEvaluator(NarrowingStage<Result> condition) {
