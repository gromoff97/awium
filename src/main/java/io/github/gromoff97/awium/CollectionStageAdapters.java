...
final class CollectionStageAdapters {

abstract static class CollectionTerminals<E, C extends Collection<E>>
        extends ObjectStageAdapters.ObjectTerminals<C> {
...
abstract static class CollectionConfigStages<E, C extends Collection<E>>
    ...
    public final CollectionUntil<E, C> stableFor(Duration stability) {
...
static final class CollectionTerminalStage<E, C extends Collection<E>>
        extends CollectionTerminals<E, C> implements CollectionUntil<E, C> {
